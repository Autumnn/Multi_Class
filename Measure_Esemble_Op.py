...
for Dir in dirs:
    ...
    methods = ["XGBoost",  "XGBoost-RA", "XGBoost-BA", "XGBoost-GA", "XGBoost-CMA", "XGBoost-PYS",
               "XGBoost-All", "META-DES-XGBoost", "MCB-XGBoost", "DES-MI-XGBoost"]
    for m in methods:
        print('Method: ', m)
        Num_Cross_Folders = 5
        ...
        for file in files:
            ...
            if m == 'XGBoost':
                ...
                if m.split('-')[0] == 'XGBoost':
                    ...
                    para_dir = Op_Path + algorithm + '_use/' + Dir + "/" + para_file
        ...
        file_wirte = "Result_Esemble_Op_Compare_S.txt"
