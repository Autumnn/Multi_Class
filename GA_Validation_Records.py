...
#            plog.reset_timer()
    ...
    return best_ind, best_ind.fitness.values, metric_value_list, opt_para, all_res  # return the result:Last individual,The Return of Evaluate function
...
#    plog = PrintLog(para_keys)
    ...
    for file in files:
        ...
        with open(sub_name + '_GA_List.json', 'a') as outfile:
