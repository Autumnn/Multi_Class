...
for Dir in DIRS:
    ...
    list_path = os.makedirs(save_path + '/CMA_Timeline_Record_Validation/' + Dir)
    para_path = os.makedirs(save_path + '/CMA_Validation/' + Dir)
    ...
    for file in files:
        ...
        with open('CMA_Opt_G_Mean_Validation_Records.txt', 'a') as w:
            line = sub_name + '\t' + str(max_val) + '\n'
            w.write(line)

        para_file = save_path + '/CMA_Validation/' + Dir + '/' + sub_name + '_CMA.json'
        ...
        list_file = save_path + '/CMA_Timeline_Record_Validation/' + Dir + '/' + sub_name + '_CMA_List.json'
        Output_line = {}
