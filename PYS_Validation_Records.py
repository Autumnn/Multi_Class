...
for Dir in DIRS:
    ...
    list_path = os.makedirs(save_path + '/PYS_Timeline_Record_Validation/' + Dir)
    para_path = os.makedirs(save_path + '/PYS_Validation/' + Dir)
    ...
    for file in files:
        ...
        with open('PYS_Opt_G_Mean_Validation_Records.txt', 'a') as w:
            line = sub_name + '\t' + str(max_val) + '\n'
            w.write(line)

        para_file = save_path + '/PYS_Validation/' + Dir + '/' + sub_name + '_PYS.json'
        ...
        list_file = save_path + '/PYS_Timeline_Record_Validation/' + Dir + '/' + sub_name + '_PYS_List.json'
        Output_line = {}
