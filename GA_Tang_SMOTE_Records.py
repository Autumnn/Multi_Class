...
save_path = "Tang_SMOTE_Result_and_Para"
os.makedirs(save_path)

dir_path = "Tang_SMOTE_npz"
Dir = dir_path.split('_')[0]
files = os.listdir(dir_path)  # Get files in the folder
result_file = save_path + '/GA_Opt_G_Mean_SMOTE_Records_' + str(Dir) + '.txt'
para_path = save_path + '/GA_Validation'
...
for file in files:
    ...
    list_path = save_path + '/GA_Timeline_Record_Validation/' + sub_name
